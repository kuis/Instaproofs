...
module.exports = {
	...
	dictionary: {
		...
		events: {
			...
			'Showcased Events': 'Основные События',
			'Showcased': 'Основные',
		...
		lightbox: {
			...
			// Buy Form ==============================================================
			'Save this as my default set': 'Сохранить как список по умолчанию',
			'Save as default': 'Запомнить выбор',
			'Total:': 'Всего:',
			'Cancel': 'Отмена',

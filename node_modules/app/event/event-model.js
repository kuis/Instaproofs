...
module.exports = BaseModel.extend({
  ...
  initialize: function () {
    ...
    this.listenTo(this, 'change:server_active', function () {
      app.view.updateMaintenanceStatus();
      if (this.server_active === false) app.trigger('reload-images');
    });
  },
  ...
  checkServerStatus: function (cb) {
    ...
    xhr.get(url, function (err, resp, body) {
      ...
      console.log('server_active', self.server_active, body);

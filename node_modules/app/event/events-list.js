...
module.exports = BaseView.extend({
  ...
  initialize: function (ops) {
    ...
    this.collection = new EventsCollection(null, {
      filter: ops.filter || this.defaultFilter,
      sort: ops.sort || this.defaultSort,
    });
    this.groupViews = [];
  ...
  setFilter: function (filter) {
    this.collection.filteredBy = filter || this.defaultFilter;
  },

  setSort: function (sort) {
    this.collection.sortedBy = sort || this.defaultSort;
  },
});

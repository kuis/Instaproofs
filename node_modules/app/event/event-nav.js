...
module.exports = NavContents.extend({
  ...
  updateBackButton: function () {
    ...
    console.log('back button', item && item.type);
    if (!item || !item.shortTitle) {
      ...
      if (item.type === 'event') title = this.lz('Overview');
      // if (item.type === 'event-favorites') title = this.lz('Favorites');
      if (item.type === 'lightbox') title = this.lz('Photos');

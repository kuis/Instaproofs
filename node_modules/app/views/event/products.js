/*==========================================================================*\
  List of products on event's page
\*==========================================================================*/
"use strict";

var Parent = require('app/views/base-view');
var ProdView = require('./product-item');
...
module.exports = Parent.extend({
  ...
  render: function () {
    ...
    console.log('render products', this.collection.length);
    this.renderCollection(this.collection, ProdView, this.query('.products'), {
      viewOptions: {
        preview: true,
      },
    });

...
module.exports = Parent.extend({
  ...
  touchend: function (e) {
    ...
    if (this.gesture.direction < 0) {
      this.el.style[ua.css.transitionDuration] = 
          ((this.gesture.winHeight - Math.abs(this.gesture.y - this.gesture.startY)) / this.gesture.winHeight * 400) 
          + 'ms';
      this.hide();
    }
    else {
      this.el.style[ua.css.transitionDuration] = 
          (Math.abs(this.gesture.y - this.gesture.startY) / this.gesture.winHeight * 400) 
          + 'ms';
    }
    e.preventDefault();
  },

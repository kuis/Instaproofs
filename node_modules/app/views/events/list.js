...
var EventGroupView = require('app/views/events/group');
...
module.exports = Parent.extend({
  ...
  render: function () {
    ...
    // var groups = this.collection.groupBy(this.separators[sortedBy]);
    
    // if (this.groupViews) { // cleanup old views 
    //   this.groupViews.forEach(function (view) {
    //     view.remove(); 
    //     view.stopListening();
    //   });
    // }
    ...
    // this.groupViewsMap = {};
    // this.groupViews = _.map(groups, function (group, key) {
    //   return self.groupViewsMap[key] = new EventGroupView({ 
    ...
    // if (sortedBy === 'type') {
    //   this.groupViews = _.sortBy(this.groupViews, function (a) {
    ...
    // this.displayedCount = +this.collection.length;
    return this;
  },

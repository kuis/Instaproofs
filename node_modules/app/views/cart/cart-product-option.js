...
module.exports = Parent.extend(require('bind-transforms')).extend({
  template: require('app/templates').cart['cart-product-option'],
  ...
  render: function () {
    ...
    this.photos = this.renderCollection(this.collection, PhotoView, 
  ...
  updateCount: function () {
    ...
    // this.query('.spots-left').innerHTML = left > 0
    //     ? this.lz('%d/%d images selected', selected, capacity)
    //     : this.lz('all images selected');
  },
});

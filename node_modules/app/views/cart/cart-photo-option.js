...
var AddonView = require('./cart-photo-addon');

module.exports = Parent.extend(require('bind-transforms')).extend({
  template: require('app/templates').cart['cart-photo-option'],
  ...
  initialize: function () {
    ...
    this.startQtyRoll = this.startQtyRoll.bind(this);
  },
  ...
  hide: function () {
    ...
    this.parent.parent.parent.parent.checkForEmptiness();
  },

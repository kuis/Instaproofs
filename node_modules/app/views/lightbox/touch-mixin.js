...
module.exports = {
  ...
  onTouchMove: function (e) {
    ...
    if (!g.moved && Math.abs(g.touchPos - g.startPos) <= 10) { // wait for at least 10px of movement
      return;
    }
  ...
  slideTo: function (pos, duration, cb, easing) {
    ...
    if (ua.css.transitionDuration) {
      easing = easing || 'ease';
      // $slider[0].style[ua.css.transitionDuration] = duration +'ms';
      ...
      if (ua.css.transitionEasing) {
        // $slider[0].style[ua.css.transitionEasing] = easing;
  ...
  tick: function (time) {
    ...
    var pos = (time - anim.startTime) / anim.duration; // position in animation's timeframe 

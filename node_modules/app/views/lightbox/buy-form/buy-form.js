...
module.exports = Parent.extend({
  ...
  prefill: function (cartPhotos) {
    ...
    for (i = 0; i < this.optionsView.views.length; i++) {
      ...
      cartPhoto = _.findWhere(cartPhotos, { color_id: option.model.color_id });
  ...
  save: function () {
    ...
    for (i = 0; i < this.optionsView.views.length; i++) {
      ...
      if (!cartPhotos[option.model.color_id]) {
        ...
        if (!cartPhoto) {
          console.log(this.model.eid, this.model.id);
    ...
    if (this.saveAsDefault) {
      app.defaultOptions = _.clone(cartPhotos);

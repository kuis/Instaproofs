...
module.exports = Parent.extend(require('bind-transforms')).extend({
  ...
  initialize: function (ops) {
    ...
    var params = app.router.currentParameters;
  ...
  loadVariants: function () {
    this.query('img.black').src = this.model.getUrl(8);
    this.query('img.sepia').src = this.model.getUrl(9);
  },
  ...
  shareOnFacebook: function (e) {
    return app.sharing.popup(e, 'facebook', this.model.id);
  },
  shareOnGoogleplus: function (e) {
    return app.sharing.popup(e, 'googleplus', this.model.id);
  },
  shareOnPinterest: function (e) {
    return app.sharing.popup(e, 'pinterest', this.model.id);
  },
  shareOnStumbleupon: function (e) {
    return app.sharing.popup(e, 'stumbleupon', this.model.id);
  },
  shareOnTwitter: function (e) {
    return app.sharing.popup(e, 'twitter', this.model.id);
  },
  ...
  load: function () {
    ...
    this.image.src = this.model.getUrl(7);
  },
  ...
  hideBuyForm: function () {
    ...
    if (this.buyFormInline) {
      ...
      var scaleX = this.imageWidth / imgRect.width;
      var scaleY = this.imageHeight / imgRect.height;
      console.log(this.imageHeight, scaleX, scaleY, imgRect.width, imgRect.height);

...
module.exports = Parent.extend(require('bind-transforms')).extend({
  ...
  events: {
    ...
    'mousedown .crop-covers': 'onDragMouseDown',
    'mousedown .crop-handle': 'onResizeMouseDown',
    
    'touchstart .crop-covers': 'onDragMouseDown',
    'touchstart .crop-handle': 'onResizeMouseDown',
  ...
  applyCrop: function (newCrop) {
    if (newCrop) this.currentCrop = newCrop;
    var crop = this.currentCrop;

...
var NavView = require('app/views/global/nav');
var SplashView = require('app/views/global/splash');
var LightboxNotices = require('app/views/global/lightbox-notices');
...
module.exports = Parent.extend({
  ...
  initialize: function () {
    ...
    this.handleNewNotices = _.throttle(this.handleNewNotices, 100, { 
      leading: false,
    });
    this.handleRemovedNotices = _.throttle(this.handleRemovedNotices, 100, { 
      leading: false,
    });

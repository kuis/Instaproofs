...
module.exports = BaseModel.extend({
  ...
  props: {
    ...
    // Boolean value that indicates whether the custom link should be displayed
    ...
    // whether purchasing is available on this 'store'
    ...
    private_gallery_url: ['string', true, 'img/private-gallery.png'],

    // Deteremines whether the image names should be displayed by default
    display_photo_names: ['boolean', true, false],

    // Determine which payment options should be present on the checkout page
    checkout_paypal: ['boolean', true, true],
    checkout_card: ['boolean', true, true],
  },
  
  session: {
    logoImage: 'any',
    logo_width: ['number', true, 0],
    logo_height: ['number', true, 0],
  },
  ...
  initialize: function () {
    this.listenTo(this, 'sync', function () {
      ...
      app.state.enable_cart = this.enable_cart;
      this.setupLogo();
    });
  },
  ...
  fetch: function () {
    ...
    var options = {
      error: function () {
        ...
        self.listenToOnce(app, 'online', self.fetch);
      },
    };
  ...
  parse: function (res) {
    ...
    // data.config.style = 'list';
    // data.config.style = 'login';
    // data.config.enable_cart = false;
  ...
  setupLogo: function () {
    ...
    this.logoImage.addEventListener('load', this, false);
    // this.logoImage.addEventListener('error', this, false);
    this.logoImage.src = this.logo_url;
  },
  
  handleEvent: function (e) {
    if (e && e.type === 'load') { // logo image loaded 
      this.logo_width = this.logoImage.width;
      this.logo_height = this.logoImage.height;
      this.trigger('logo-size-received');
    }
  },

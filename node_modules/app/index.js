...
// app.title is reset to company/photographer name as soon as data is loaded
app.title = document.title;

// sets page title (browser tab title) and saves it for language change 
app.setTitle = function (title, dictionary) {
  app.currentTitle = title;
  app.currentTitleDictionary = dictionary;
  updateTabTitle();
};
function updateTabTitle () {
  var title = app.currentTitle;
  if (app.currentTitle && app.currentTitleDictionary) {
    title = app.i18n.localize({
      dictionary: app.currentTitleDictionary,
      str: app.currentTitle,
    });
  }
  document.title = title ? title +' - '+ app.title : app.title;
}
app.on('language-change', updateTabTitle);

...
module.exports = Events.mixin({
  ...
  blastoff: function () {
    ...
    this.url = 'http://demo.instaproofs.com'; // URL used as ID for API requests
    ...
    this.sharing = require('app/utils/sharing');
...
var Clock = require('app/utils/clock');
var Config = require('app/models/config-model');
var Notices = require('app/models/notices-collection');

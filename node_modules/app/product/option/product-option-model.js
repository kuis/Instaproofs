...
module.exports = BaseModel.extend({
  ...
  isDigitalOnly: function () {
    var i;
    if (!this.required_size_list.length) return false;
    for (i = 0; i < this.required_size_list.length; i++) {
      if (this.required_size_list.at(i).size.type !== 'digital') return false;
    }
    return true;
  },
});

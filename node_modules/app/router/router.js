...
module.exports = Router.extend({
  ...
  setNav: function (placeholder, eid) { // sets navbar to global or event's one
    debugger;
    var view;
    ...
    view.searchPlaceholder = placeholder;
  ...
  initialize: function() {
    ...
    this.route(/^(events\/(\d+))$/, function (fullUrl, eid) {
      ...
      this.setNav('Search Category', eid);
    });

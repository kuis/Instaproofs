...
var crossFadeSchedule = null; // schedule ID for re-enabling cross-fade
...
module.exports = {
  ...
  onTouchStart: function (e) {
    ...
    if (!this.displayed || rolling || this.buyFormDisplayed) return;
    ...
    this.unschedule(crossFadeSchedule);
  },
  ...
  onAnimationEnd: function () {
    ...
    if (!rolling) return;
    // this.trigger('stop');
    if (this.current) this.current.el.style[ua.css.transitionDuration] = '0ms';
    if (this.prev[0]) this.prev[0].el.style[ua.css.transitionDuration] = '0ms';
    if (this.next[0]) this.next[0].el.style[ua.css.transitionDuration] = '0ms';
    ...
    if (this.slideshow) {
      crossFadeSchedule = this.writeAfter(100, function () {
        if (this.slideshow) {

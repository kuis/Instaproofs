...
module.exports = BaseView.extend(SlideshowMixin, TouchMixin, {
  ...
  reset: function (ops) {
    ...
    this.buyOnly = params.buyOnly || params.crop;
    ...
    this.listenTo(this.event.hides, 'change:mtime', function () {
      this.updateCount();
    });
  ...
  updateCategoriesPositioning: function () {
    ...
    var width = this.categoriesDropdown.offsetWidth;
    if (width > toRight) {

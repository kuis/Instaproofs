...
module.exports = ViewSwitcher.extend({
  ...
  switcher: function (done, newView, oldView) {
    ...
    schedule(function () {
      ...
      if (newView.fixedFooter1) {
        newView.fixedFooter1.el.classList.remove('hidden');
        this.footer.appendChild(newView.fixedFooter1.el);
    ...
    var onTransitionEnd = function () {
      ...
      schedule(function () {
        if (oldView.fixedFooter1) oldView.fixedFooter1.remove();
    ...
    schedule(function () {
      if (oldView) {
        ...
        if (oldView.fixedFooter1) {
          oldView.fixedFooter1.el.classList.add('hidden');
        }

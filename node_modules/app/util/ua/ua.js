...
var mobileWebkit = userAgent.match(/AppleWebKit\/([\d.]+)/);
ua.aosp = mobileWebkit && mobileWebkit[1] && +mobileWebkit[1] < 537;
...
ua.css.transformOrigin = getSupportedPropertyName('transformOrigin');
...
if (ua.requestFullscreen) {
  ua.requestFullscreen = ua.requestFullscreen.bind(html);
}

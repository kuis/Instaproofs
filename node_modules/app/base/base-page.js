...
module.exports = BaseView.extend({
  ...
  nearBottomDistance: 1400, // how far from the bottom do we trigger load more 
  ...
  initialize: function () {
    ...
    if (this.hasHeaderLogo) {
      ...
      this.listenTo(app, 'reload-images', this.reloadHeaderLogo);
    }
  },
  ...
  reloadHeaderLogo: function () {
    if (!this.el || !app.state.bootstrapped) return;
    this.query('.header-logo').removeAttribute('src');
    this.after(100, this.onLogoUrlChange);
  },

...
module.exports = BaseView.extend({
  ...
  initialize: function () {
    ...
    if (this.hasHeaderLogo) {
      console.log('hasLogo', app.state.bootstrapped);
  ...
  onLogoSizeChange: function () {
    ...
    console.log('logoHeight', height);
    
    
    // var img = this.query('.header-logo');
    // if (img) {
    //   img.width = app.config.logo_width;
    //   img.height = app.config.logo_height;
    // }
  },
  ...
  updateHeaderLogo: function () {
    ...
    console.log('offset', offset, this.scroll.top);
    // app.view.nav.noLogo = this.hasHeaderLogo && this.scroll.top < offset;
  ...
  setTitle: function (title, shortTitle) {

...
module.exports = AmpersandModel.extend({
  ...
  dataTypes: {
    ...
    moment: {
      ...
      get: function (val) {
        return val === false || val === null ? false : moment(val);
      },
  ...
  round5ToFloor: function (val) {
    var pointVal = val - Math.floor(val);

    return pointVal > 0.5 ? Math.ceil(val) : Math.floor(val);
  },

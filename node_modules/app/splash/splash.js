...
module.exports = BaseView.extend({
  ...
  showLoginForm: function (event) {
    ...
    //Save the display_opt_in config value for use on the login.jade template
    this.config_optInt = app.config.display_opt_in;
  ...
  login: function () {
    ...
    var optIn = this.query('.optIn input');
    ...
    optIn = (app.config.display_opt_in) ? optIn.checked : true;
    app.keychain.saveEventKeys(this.model, email.value, password.value, optIn);

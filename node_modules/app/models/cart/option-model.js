...
var AddonsCollection = require('./addons-collection');
var ShippingCollection = require('./shipping-prices-collection');
...
module.exports = Parent.extend({
  ...
  getDiscount: function (event) {
    return event.discounts.sizes.get(this.id) || event.discounts.allSizes;
  },

...
var BuyOption = BaseModel.extend({
  ...
  derived: {
    ...
    discount: {
      ...
      fn: function () {
        var e = this.event;
        return e.discounts.sizes.get(this.size_id) || e.discounts.allSizes;
      },
    },
    display_price: {
      cache: false,
  ...
  initialize: function () {
    ...
    this.listenTo(this.event.discounts, 'update', this.updateDiscount);
  },
...
module.exports = BaseModel.extend({
  ...
  session: {
    ...
    current_color_id: ['number', true, 7],

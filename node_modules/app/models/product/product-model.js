...
var PhotosListCollection = require('./photos-list-collection');
var ProductOptionCollection = require('./product-options-collection');
...
module.exports = require('app/models/base-model').extend({
  ...
  collections: {
    ...
    option: ProductOptionCollection,
    photosList: PhotosListCollection,
  },

...
module.exports = Parent.extend({
  ...
  children: {
    discounts: require('./event-discounts-model'),
  },
  ...
  derived: {
    ...
    thumb_url: {
      ...
      fn: function () {
        ...
        var url = this.toThumbURL(this.img_url);
        return this.display_image ? url : this.toBlurURL(url);
      },
    },
    // thumb_blur_url: {
    //   deps: ['img_url'],
  ...
  parse: function (res) {
      ...
      general: [
        {
          ...
          expires: '2015-12-01T00:00:00-07:00',
          description: 'Products are 15% off',
        },
        {
          size_discount: 0.10,
          product_discount: 0,
          expires: '2015-11-07T20:00:00-07:00',
      ...
      size_override: [
        {
          id: 14,
          discount: 0.20,
          expires: '2015-10-28T20:00:00-05:00',
    ...
    var i, j;
    var photosPresent = data.categories && data.categories[0] && 
                data.categories[0].photos && data.categories[0].photos.length;

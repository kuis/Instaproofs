...
var app = require('app');
var Parent = require('app/models/base');
var AddonsCollection = require('app/models/purchase-addons');
...
module.exports = Parent.extend({
  props: {
    ...
    type: ['string', true, ''], // print|digital
    price: ['number', true, 0], // price of an option in cents
    no_qty: ['boolean', true, false], // an option like Instant Download with no qty
  ...
  parse: function (data) {
    ...
    if (data.addon_ids && data.addon_ids.length) {
      ...
      for (var i = 0; i < data.addon_ids.length; i++) {
        addon = app.purchaseAddons.get(data.addon_ids[i]);

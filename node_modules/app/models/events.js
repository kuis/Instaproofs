...
module.exports = Collection.extend({
  ...
  addNewItems: function () {
    ...
    while (this.newItems.length && i < 2) {
      ...
      if (app.eventModels[id]) {
        ...
        // console.log('added already present event', id);
      }
      else {
        // console.log('added new event', id, Object.keys(app.eventModels).length);
  ...
  fetch: function (options) {
    ...
    // var perPage = this.page ? this.perPage * 2 : this.perPage;
    
    data.limit = this.perPage;
    data.offset = this.page * this.perPage;
    // data.limit = this.page ? this.perPage * 2 : this.perPage;
    // data.offset = this.page ? this.perPage + (this.page - 1) * this.perPage * 2
    //                         : 0;
    ...
    if (options.reset) {
      options.success = function (col, resp) {
        self.cache[data.filter + data.sort] = resp;
        self.request = null;
      };
      ...
      return this.request = Collection.prototype.fetch.call(this, options);
    }

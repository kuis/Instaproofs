/*==========================================================================*\
  ...
  You custom switcher will also recieve a second argument passed to .set():
    var PageSwitcher = ViewSwitcher.extend({
...
module.exports = Class.extend(Events.mixin({
  ...
  _switch: function (options) {
    ...
    var self = this;
    setTimeout(function () {
      self.switcher(self._onAfterSwitch, self.current, self.previous[0], options);
    }, 112);
  },
  ...
  _onAfterSwitch: function () {
    ...
    this.previous = [];
    // if (this.previous) this.previous.remove(app.state.noTransitions && 'high');

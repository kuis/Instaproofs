...
module.exports = Parent.extend({
  ...
  props: {
    currentTrack: 'string', // URL of the current track 
  ...
  playNext: function () {
    ...
    this.el.setAttribute('src', this.currentTrack);
    this.play();
  },
  ...
  setTracks: function (tracks) { // update playlist
    ...
    if (!this.playing || this.tracks.indexOf(this.currentTrack) < 0) {
      this.el.setAttribute('src', this.tracks[0]);

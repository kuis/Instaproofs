...
module.exports = BaseView.extend({
  ...
  bindings: {
    ...
    //   type: function (el, val) {
    //     el.innerHTML = this.model.formatMoney(val);
    //     // console.log(val + (this.model.price - this.model.discounted_price) * this.qty);
    //     this.query('.head .original-price').innerHTML = this.model.formatMoney(
    //       val + (this.model.price - this.model.discounted_price)
    //     );
    //   },
    //   selector: '.head .discounted-price',
    // },
  ...
  toggleCropping: function () {
    ...
    if (photo.croppingMode && photo.currentCrop === this.crop) {
      ...
      console.log('enter cropping', this.crop);

...
module.exports = BaseModel.extend({
  ...
  initialize: function (options) {
    ...
    //The sizeStr should always be width x height, regardless of the crop orientation
    this.sizeStr = this.option.model.size.width +' x '+ this.option.model.size.height;
  ...
  reset: function (options) {
    ...
    this.changed = false;
    if (wasChanged) this.trigger('change');
  },
  rotate: function () {
  ...
  save: function () {
    ...
    if (this.changed && !this.option.model.no_qty && !this.option.qty) {
      this.option.qtyView.plus();
    }
  },

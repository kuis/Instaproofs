  ...
  .head
    .name
      ...
      span.short-name
        ...
        if this.cartProduct
          span.spots-left!= lz('%d/%d left', this.cartProduct.spotsLeft[model.id], this.cartProduct.capacity[model.id])
      if model.size.description || model.size.img_url
        .info
    span.bulk-pricing

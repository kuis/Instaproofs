...
module.exports = BaseView.extend({
  ...
  derived: {
    onFavPage: {
      fn: function () {
        return this.parent.parent.parent.isFavPage;
      },
    },
  },
  ...
  events: {
    // 'click .icon.share': 'addShareOverlay',
  ...
  addShareOverlay: function(e) {
    var overlayContainer = e.target.offsetParent.firstChild;
    if (!this.shareView) {
    ...
    overlayContainer.className = 'View-large';
    overlayContainer.innerHTML = this.shareView.el.outerHTML;
  },

...
module.exports = BaseModel.extend({
  ...
  derived: {
    ...
    download_url: {
      cache: false,
      fn: function () {
        if (!this.cat_id || this.cat_id === 'favorites') return false;
        console.log(this.collection, this.cat_id);
        console.trace();
        if (!this.event.categories.get(this.cat_id).download) return false;

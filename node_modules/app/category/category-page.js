...
module.exports = Page.extend({
  ...
  derived: {
    ...
    description: {
      deps: ['categoryModel', 'model'],
      fn: function () {
        return this.categoryModel.notes ? this.categoryModel.notes : this.model.description;
      }
    }
  },
  ...
  initialize: function (ops) {
    ...
    if (this.model.complete) {
      ...
      var catName = this.model.categories.get(this.categoryID).name;
      this.setTitle(catName +' - '+ this.model.name, catName);
      this.write(function () {
        this.fixedFooter.render();
      });
    }
    else this.listenTo(this.model, 'change:complete', function () {
      this.fixedFooter.model = this.model.categories.get(this.categoryID);
      var catName = this.model.categories.get(this.categoryID).name;
      this.setTitle(catName +' - '+ this.model.name, catName);
      this.write(function () {

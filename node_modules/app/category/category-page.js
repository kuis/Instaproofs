...
module.exports = Page.extend({
  ...
  subviews: assign({}, Page.prototype.subviews, {
    category: {
      ...
      prepareView: function (el) {
        ...
        this.fixedFooter1.model = this.category.model;
        this.fixedFooter2.model = this.category.model;

        this.write(function () {
          this.queryByHook('category-name').innerHTML= this.category.model.name;
          if (!this.complete) {
            this.renderSubview(this.fixedFooter2, '#prev-next-container');
          } else {
            this.fixedFooter1.render();
          }
        });
  ...
  initialize: function (ops) {
    ...
    this.fixedFooter1 = new FixedFooter({
      parent: this
    });

    this.fixedFooter2 = new FixedFooter({
      parent: this
    });
    ...
    this.onModelComplete(function () {
      ...
      this.setTitle(catName +' - '+ this.model.name, catName, true);

      this.render();

      if (this.model.complete) { this.checkForFullDownload(); }
  ...
  onNearBottom: function () {
    if (ua.mobile || this.complete || !this.category) return;
    this.category.showMore();
    return this;
  },
  onShow: function () {

...
module.exports = CartPage.extend(PaypalMixin, {
  ...
  updateShippingType: function (shippingCountryId) {
    if(shippingCountryId !== 0) {
      var photographerCountry = app.config.photographer.country;
      var buyerCountry = app.countries.get(shippingCountryId).name;

      if (photographerCountry.toLowerCase() !== buyerCountry.toLowerCase()) {
  ...
  readFormData: function (formType) {
    ...
    data[formType + '_address1'] = '';
    data[formType + '_address2'] = '';

    for (var i = 0; i < elements.length; i++) {
      el = elements[i];
      if (!this.model.address_required && formType === 'shipping' &&
         (el.name === 'address1' || el.name === 'address2')) {
        data.shipping_address1 = 'N/A';
      ...
      switch (el.name) {
        ...
        case 'address1': data[formType +'_address1'] = el.value; break;
        case 'address2': data[formType +'_address2'] = el.value; break;

...
module.exports = CartPage.extend(PaypalMixin, {
  ...
  events: {
    ...
    'change input[type="radio"][name="payment-type"]': 'onPaymentTypeChange'
  },
  ...
  bindings: {
    ...
    isPaypal: {
      type: 'booleanClass',
      selector: '.payment-type.paypal',
      name: 'active'
    },

    notPaypal: {
      type: 'booleanClass',
      selector: '.payment-type.credit-card',
      name: 'active'
    }
  },
  ...
  checkoutPaypal: function () {
    ...
    // Show loading sign
    this.query('.button.paypal').classList.add('loading');
    ...
    self.startTransaction(cid, {
      ...
      // Hide loading sign
      self.query('.button.paypal').classList.remove('loading');
  ...
  onPaymentTypeChange: function (event) {
    this.paymentType = this.query('input[type="radio"][name="payment-type"]:checked').value;
  }

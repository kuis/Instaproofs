...
module.exports = CartPage.extend(PaypalMixin, {
  ...
  submit: function (e) {
    ...
    //if (!this.model.digitalOnly) {
      ...
      if (!shipping) {
        this.alert(this.lz('Please fill in a complete shipping address.'));
        return;
      }
    //}
    //else {
    ...
    if (this.model.total) {
      ...
      if (this.model.paymentMethod === 'card' && !billing) {
        this.alert(this.lz('Please fill in a complete billing address.'));
        return;
      }
    ...
    this.xhr = xhr({
      ...
      if (body.status === 200) {
        ...
        self.alert(self.lz('Error submitting the order.') +
  ...
  validate: function () {
    ...
    if (this.model.total && this.model.paymentMethod === 'card') {
      ...
      if (!payment.card_num) {
        this.alert(this.lz('Please fill in your credit card number.'), {
          onOk: function () {
      ...
      if (!this.expMonthEl.value) {
        this.alert(this.lz(
            "Please fill in your credit card's expiration date."
        ), {
          onOk: function () {

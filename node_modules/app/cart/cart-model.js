...
module.exports = BaseModel.extend({
  ...
  derived: {
    address_required: {
      deps: ['digitalOnly', 'shipping_type'],
      fn: function () {
        return !this.digitalOnly && this.shipping_type > 0;
      },
    },
    tax_hash: {
  ...
  getShippingCost: function () { // only called from updateSummary
    ...
    console.log(app.config.shipping_method); 
    console.log('printsTotal', printsTotal);
    ...
    console.log('shipping', finalCost);
    return finalCost;
  },

...
var DiscountCode = require('./discount-code-model');
...
module.exports = BaseModel.extend({
  ...
  updateSummary: function () {
    ...
    var size, price;
    for (i = 0; i < this.photos.length; i++) {
      st = this.photos.at(i).subtotal;
      subtotal += st;
      discount += (st - this.photos.at(i).total);
      ...
      //   }
      // }
      // console.log('photo', st);
    }
    for (i = 0; i < this.products.length; i++) {
      st = this.products.at(i).basePrice;
      subtotal += st;
      discount += (st - this.products.at(i).price);
      // console.log('product', this.products.at(i).price);
    }
    ...
    // console.log('tax_total', this.tax_total);
    this.total = subtotal - this.discount + 
                 this.shipping_total + this.tax_total;
  },

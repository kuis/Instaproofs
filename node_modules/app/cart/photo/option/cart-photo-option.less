.cart-photo-item {
  ...
  .td {
      ...
      > .bulk-pricing {
        ...
        > .bulk-tip {
          ...
          &:after {
            ...
            border-right: 5px solid @highlighted;
          }
        }
      }
    ...
    &.price {
      ...
      .desktop-ua .has-some-discount&:hover {
        cursor: auto;
        > .price-base { display: inline; }
    ...
    &.actions {
      ...
      width: 34px;
      padding: 0;
      .desktop-ua & { visibility: hidden; }
      :hover& {
        .desktop-ua & { visibility: visible; }
      }
      ...
      .action {
        ...
        .desktop-ua &:hover > .popover { display: block; }
        > .popover {
          opacity: 0;
          animation: fadeIn 300ms 100ms forwards;
          display: none;
          height: 32px;
          line-height: 32px;
          top: 12px;
  ...
  .name, .bulk-pricing, .discount, .crop, .price.single {

...
module.exports = BaseView.extend({
  ...
  bindings: {
    ...
    'model.discount_code_discount': {
      type: function (el, val) {
        el.textContent = '-'+ this.model.formatMoney(val);
        this.el.classList.toggle('code-discount-positive', !!val);
      },
      selector: '.code-discount-price',
    },
    'model.shipping_type': {
      type: 'value',
  ...
  render: function () {
    ...
    //   this.model.shipping_type = 1; // default shipping type ID: 1
    //   this.model.store();
    // }

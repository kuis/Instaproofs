...
module.exports = BaseView.extend({
  viewType: 'cart-product-photo',
  template: require('app/templates').cart.product['cart-product-photo'],
  ...
  initialize: function (ops) {
    ...
    this.noCrop = !app.config.crop_enabled;
  ...
  applyCrop: function (newWidth) {
    ...
    var crop = option.crop.toJSON();
    if (!option.crop.changed) {
      if (app.config.show_crop) {
    ...
    if (!newWidth && isEqual(this.appliedCrop, crop)) return;

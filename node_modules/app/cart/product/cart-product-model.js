...
module.exports = BaseModel.extend({
  ...
  derived: {
    ...
    name: {
      cache: false,
      fn: function () {
        return this.option.name || this.product.name;
      },
    },
    ...
    shipping_price: {
      ...
      cache: false,
      fn: function () {
        //If the shipping type is 0 ("pick up"), the price is always 0
        if (this.cart.shipping_type === 0) return 0;
        // if (!this.option.include_in_shipping_calcs) return 0;

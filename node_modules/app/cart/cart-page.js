...
var Summary = require('./cart-summary');
...
module.exports = Page.extend({
  ...
  checkout: function () {
    if (!this.model.valid) {
      this.alert("Some of the products don't have "+
                       "all the required photos selected yet.");
      return;
    }
  ...
  applyDiscountCode: function () {
    var code = this.query('.summary-options .discount input').value;
    code = code.trim();
    if (!code) return;
